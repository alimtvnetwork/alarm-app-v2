...
async function safeInvoke<T, P extends Record<string, string | number | boolean | null | string[]> = Record<string, string | number | boolean | null | string[]>>(cmd: string, args?: P): Promise<T | null> {
    try {
...
`Alarms` (26 columns) | `AlarmGroups` (5) | `Settings` (3, key-value with ValueType) | `SnoozeState` (3) | `AlarmEvents` (13) | `Quotes` (6, P2) | `Webhooks` (5, P3)
