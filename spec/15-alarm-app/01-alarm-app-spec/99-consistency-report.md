...
| # | File | Status |
|---|------|--------|
| 1 | `00-overview.md` | ✅ Present (v2.8.1) |
...
| 7 | `98-changelog.md` | ✅ Present (v2.8.1 — v1.0.0 → v2.8.1) |
...
| 4 | `14-spec-issues/` | ✅ (v1.35.0) | — | — | ✅ 417/417 resolved |
...
| Spec issues: 417 total, 417 resolved, 0 open | ✅ |
