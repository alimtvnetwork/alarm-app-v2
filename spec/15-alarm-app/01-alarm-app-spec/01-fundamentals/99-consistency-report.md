...
| # | File | Version | Status |
|---|------|---------|--------|
| 1 | `00-overview.md` | 1.6.0 | ✅ Present |
...
| 7 | `06-tauri-architecture-and-framework-comparison.md` | 1.7.0 | ✅ Updated (plugin versions + API signatures, auto-start IPC commands) |
