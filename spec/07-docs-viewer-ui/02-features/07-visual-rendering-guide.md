...
![Heading hover dark](/images/guide/08-heading-hover-dark.png)
...
![H3 hover dark](/images/guide/09-h3-hover-dark.png)
...
![Link hover dark](/images/guide/10-link-hover-dark.png)
...
![Inline code hover dark](/images/guide/11-inline-code-hover-dark.png)
...
![Code block hover dark](/images/guide/12-codeblock-hover-dark.png)
...
![Heading hover light](/images/guide/13-heading-hover-light.png)
...
![Inline code hover light](/images/guide/14-inline-code-hover-light.png)
...
![Link hover light](/images/guide/15-link-hover-light.png)
...
```
/docs?file=spec/02-coding-guidelines/03-coding-guidelines-spec/01-cross-language/04-code-style/01-braces-and-nesting.md
```
...
│                             │
│  📄 Keyboard Navigation     │
│     spec/07-docs-viewer-ui/ │  ← Path shown as subtext
│  📄 Fundamentals            │
│     spec/07-docs-viewer-ui/ │
...
| Reference | Location |
|-----------|----------|
| Theme & Animation Spec | `spec/07-docs-viewer-ui/02-features/06-ui-theme-animations.md` |
| Syntax Highlighting Spec | `spec/07-docs-viewer-ui/02-features/02-syntax-highlighting.md` |
| Typography Spec | `spec/07-docs-viewer-ui/02-features/01-typography.md` |
