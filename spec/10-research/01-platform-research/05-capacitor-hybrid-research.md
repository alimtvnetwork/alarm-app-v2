...
Evaluating Capacitor specifically for the Alarm App project (cross-reference: `../../15-alarm-app/01-fundamentals/05-platform-strategy.md`):
...
| Alarm App Platform Strategy | `../../15-alarm-app/01-fundamentals/05-platform-strategy.md` |
