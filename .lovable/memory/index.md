...
- [Alarm App Spec Issues Audit](mem://feature/alarm-app-spec-issues) — 77 issues (48 open, 29 resolved) across 8 categories. 6 discovery phases done, 11 fix phases pending (5–15).
